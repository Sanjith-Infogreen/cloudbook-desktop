        ...
        return (
          <div className="p-4 pt-0 mt-7">
            ...
            <p className="text-gray-600">
              This section would display a general overview of SMS notifications,
              such as summary statistics or recent activity.
            </p>
          </div>
        );
          ...
          <div className=" pt-0  bg-[#fafafa]">
            <div className="flex items-center  px-3 py-5 ">
              ...
              <div className="relative">
                ...
                <select className="appearance-none bg-white border border-gray-300 text-gray-700 py-1 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-blue-500 text-sm">
                  <option>All</option>
              ...
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-gray-200 bg-white text-[13px]">
                  {smsTemplates.map((template) => (
                    <tr key={template.id} className="hover:bg-[#f6f6fa] cursor-pointer">
                      ...
                      <td className="py-[30px]  px-[6.5px]">
                        ...
                        <div className="sms-preview-layout">
                          ...
                          <div className="relative inline-block w-full p-3  cursor-pointer whitespace-pre-wrap text-[13px] bg-[#f9f9fb] border border-dashed border-[#dcdcdc] rounded text-start  ">
                            ...
                            <span className="block pr-6 ">{template.smsContent}</span> 
                          </div>
                        </div>
                      </td>
