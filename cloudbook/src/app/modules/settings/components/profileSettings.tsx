...
// Mock Input component (since the original is from '@/app/utils/form-controls')
interface InputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  // Add any specific props from the original Input component if known
}

const Input: React.FC<InputProps> = ({ className, ...rest }) => (
  <input
    className={`form-control w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#009333] ${className}`}
    {...rest}
  />
);

// Mock RadioGroup component (since the original is from '@/app/utils/form-controls')
...
const ProfileSettings: React.FC<ProfileSettingsProps> = ({ activeReport, activeCategory }) => {
  ...
  // Options for Proprietor Salutation RadioGroup
  ...
  // Handler for RadioGroup specifically (since its onChange signature is slightly different)
  ...
  return (
    <div className="flex flex-col"> {/* Added a wrapper div */}
      <div className="p-2 bg-white flex-grow overflow-y-auto max-h-[calc(100vh-128px)]  h-[calc(100vh-128px)]">
