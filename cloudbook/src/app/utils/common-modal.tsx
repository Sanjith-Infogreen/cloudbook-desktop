...
const CommonModal: React.FC<CommonModalProps> = ({ isModalOpen, closeModal }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50" onClick={closeModal}>
    
      <div className="bg-white rounded-[0.5rem] w-full max-w-[85%] min-h-[calc(100vh-90px)] flex flex-col custom-helvetica" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex flex-col md:flex-row md:flex-nowrap items-end gap-3 p-6">
                  ...
                  <div className="w-full md:w-1/3 flex justify-start">
                    <div className="flex items-center gap-3">
                      ...
                      {/* Using a simple refresh icon as ri-refresh-line might require an external library */}
                      <i
                        onClick={handleRefresh}
                     className="ri-refresh-line text-[#0d6efd] font-semibold text-[18px] cursor-pointer"></i> 
                    </div>
                  </div>
                </div>
              </div>
